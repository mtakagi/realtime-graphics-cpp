...
class vec2 {
   public:
    ...
    [[nodiscard]]
    constexpr vec2(double e0)
        : e{e0, e0} {}

    [[nodiscard]]
    constexpr vec2(double e0, double e1)
        : e{e0, e1} {}
    ...
    constexpr void setX(double x) noexcept { e[0] = x; }

    constexpr void setY(double y) noexcept { e[1] = y; }
    ...
    constexpr vec2& operator/=(const double t) { return *this *= 1 / t; }
